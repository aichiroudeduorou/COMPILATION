...
;INFORNAMEFMT DB "%s %s",0AH,0DH,0
SEPERATE DB 0AH,"%d:",0AH,0DH,0
SHOPNAME DB '---------ONLINE SHOP---------',0
MENULINE DB '--------------MENU---------------',0
INFORNAME DB 'THE GOOD NAME IS:',0
...
SORT:
	MOV EDI,OFFSET SORTPROFIT
	MOV AX,WORD PTR [GA1]+18
	MOV WORD PTR [EDI],AX
	MOV AX,WORD PTR [GA2]+18
	MOV WORD PTR [EDI]+2,AX
	MOV AX,WORD PTR [GA3]+18
	MOV WORD PTR [EDI]+4,AX
	MOV AX,WORD PTR [GA4]+18
	MOV WORD PTR [EDI]+6,AX
	MOV EBX,1 ;EBX TO EHECK WHETHER SORT OK
	MOV CX,WORD PTR COUNT     ;IMPROVE
LOOP1:
	CMP EBX,0
	JZ SORTEND
	XOR EBX,EBX
...
LOOP2:
	...
	CMP EAX,EDX ;COMPARE A AND B,A>B,NEXT;A<B,EXCHANGE
	JLE EXCHANGE
	JMP LOOP3
EXCHANGE:
	XCHG EAX,EDX
...
INFORPROFITLOOP:   ;IMPROVE
	MOV ESI,OFFSET GA1
	MOV AX,WORD PTR [EDI]
	CMP AX,WORD PTR [ESI]+18
	JZ SHOWPROFITINFOR
	MOV ESI,OFFSET GA2
	MOV AX,WORD PTR [EDI]
	CMP AX,WORD PTR [ESI]+18
...
SHOWPROFITINFOR:
	...
	MOV DX,5
	SUB DX,CX
	INVOKE printf,OFFSET SEPERATE,DX
	CALL SHOWGOODINFORMATION
	ADD EDI,2
	POP CX
	DEC CX
	CMP CX,0
...
FUSHU:
	...
	INVOKE printf,OFFSET CFMT,BYTE PTR OP
...
SHOWGOODINFORMATION:
	INVOKE printf,OFFSET INFORNEGFMT,OFFSET INFORNAME
	INVOKE printf,OFFSET LPFMT, ADDR [ESI]
